...
const ALL_ADS: Ad[] = [
    {
      ...
      tittle: 'Curso Profesional de JavaScript',
      body:
  ...
  
    {
      ...
      tittle: 'Curso de Frontend Developer',
      body:
  ...
  
    {
      ...
      tittle: 'Curso de Backend con Node.js',
      body:
  ...
  
    {
      ...
      tittle: 'Curso de Autenticación con Passport.js',
      body:
  ...
  
    {
      ...
      tittle: 'Curso de Backend for Frontend',
      body:
  ...
  
    {
      ...
      tittle: 'Curso Práctico de React JS',
      body:
  ...
  
    {
      ...
      tittle: 'Curso de React Router y Redux',
      body:
